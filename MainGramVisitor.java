...
public interface MainGramVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitDec(MainGramParser.DecContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code checkIDList}
	 * labeled alternative in {@link MainGramParser#idList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCheckIDList(MainGramParser.CheckIDListContext ctx);
	/**
	 * Visit a parse tree produced by the {@code checkInput}
	 * labeled alternative in {@link MainGramParser#input}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCheckInput(MainGramParser.CheckInputContext ctx);
	/**
	 * Visit a parse tree produced by the {@code dimCheck}
	 * labeled alternative in {@link MainGramParser#get}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDimCheck(MainGramParser.DimCheckContext ctx);
	/**
