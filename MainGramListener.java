...
public interface MainGramListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link MainGramParser#declaration}.
	 * @param ctx the parse tree
	 */
	void enterDec(MainGramParser.DecContext ctx);
	/**
	 * Exit a parse tree produced by the {@code dec}
	 * labeled alternative in {@link MainGramParser#declaration}.
	 * @param ctx the parse tree
	 */
	void exitDec(MainGramParser.DecContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code checkIDList}
	 * labeled alternative in {@link MainGramParser#idList}.
	 * @param ctx the parse tree
	 */
	void enterCheckIDList(MainGramParser.CheckIDListContext ctx);
	/**
	 * Exit a parse tree produced by the {@code checkIDList}
	 * labeled alternative in {@link MainGramParser#idList}.
	 * @param ctx the parse tree
	 */
	void exitCheckIDList(MainGramParser.CheckIDListContext ctx);
	/**
	 * Enter a parse tree produced by the {@code checkInput}
	 * labeled alternative in {@link MainGramParser#input}.
	 * @param ctx the parse tree
	 */
	void enterCheckInput(MainGramParser.CheckInputContext ctx);
	/**
	 * Exit a parse tree produced by the {@code checkInput}
	 * labeled alternative in {@link MainGramParser#input}.
	 * @param ctx the parse tree
	 */
	void exitCheckInput(MainGramParser.CheckInputContext ctx);
	/**
	 * Enter a parse tree produced by the {@code dimCheck}
	 * labeled alternative in {@link MainGramParser#get}.
	 * @param ctx the parse tree
	 */
	void enterDimCheck(MainGramParser.DimCheckContext ctx);
	/**
	 * Exit a parse tree produced by the {@code dimCheck}
	 * labeled alternative in {@link MainGramParser#get}.
	 * @param ctx the parse tree
	 */
	void exitDimCheck(MainGramParser.DimCheckContext ctx);
	/**
